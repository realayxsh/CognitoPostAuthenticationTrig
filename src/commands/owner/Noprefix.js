        ...
        try{
            ...
            if(op === `add`){
                ...
                if(pk === `all`){
                    ...
                    if(oo.includes(us.id)) return send(`${client.emoji.cross} | This user is already in ${guild.name}'s no prefix`);
                    oo.push(us.id);
            ...
            if(op === `remove`){
                ...
                if(pk === `all`){
                    ...
                    let oo = [];
                    db2.forEach(x => oo.push(x));
                    if(!oo.includes(us.id)) return send(`${client.emoji.cross} | This user is not in ${guild.name}'s no prefix`);
