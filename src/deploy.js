...
const commands = [
    ...
    new SlashCommandBuilder().setName('concert').setDescription('[Premium] Toggle concert hall filter'),
    new SlashCommandBuilder().setName('lofi').setDescription('[Premium] Toggle lofi filter'),
    new SlashCommandBuilder().setName('heaven').setDescription('[Premium] Toggle heaven filter'),
    new SlashCommandBuilder().setName('slowedreverb').setDescription('[Premium] Toggle slowed reverb filter'),
    new SlashCommandBuilder().setName('filters').setDescription('[Premium] Apply an audio filter')
        .addStringOption(o => o.setName('filter').setDescription('Choose a filter to toggle').setRequired(true).addChoices(
            { name: '8D',           value: '8d'          },
            { name: 'Bass Boost',   value: 'bassboost'   },
            { name: 'China',        value: 'china'       },
            { name: 'Chipmunk',     value: 'chipmunk'    },
            { name: 'Concert',      value: 'concert'     },
            { name: 'Dolby Atmos',  value: 'dolbyatmos'  },
